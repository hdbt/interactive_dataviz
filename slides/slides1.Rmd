...
-   Second Session
    ...
    -   RMarkdown, interactive visualisation and dashboards
...
<https://hdbt.shinyapps.io/translate/>
...
# Define UI for app that takes input and output ----
ui <-  fluidPage(
...
textReactive  <-  eventReactive(input$firstName,
...
[Book Plotly for R](https://plotly-r.com/preface.html) ## other
